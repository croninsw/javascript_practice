const githubData = [
  ...
  for (let i = 0; i < githubData.length; i++) {
    const commitfind = githubData[i];
    if (commitfind['id'] === '8030403992') {
        console.log(commitfind['payload']['commits'][0]['message']);
    }
}

// console.log(githubData.filter(obj => obj["id"] === "8030403992")[0]["payload"]["commits"][0]["message"]);
