...
//   console.log(types);
// }
// amountOfTypes(githubData);

// console.log(githubData[1])

// const typeFinder = (rawData) => {
//   let types = {};
//   rawData.forEach(object => {
//     let type = object.type;
//     types[type] = (types[type]+1) || 1;
...
//   console.log(types);
// }
// typeFinder(githubData)

// console.log(commitMessage)


// const commitTracker = () => {
//   let dataType = githubData[i].payload
//   console.log(dataType)
// } 

let numberOfCommits = 0
githubData.map(x => {
  if (x.payload.commits != null){
    x.payload.commits.map(commit => {
      numberOfCommits++
    })
  }
})
console.log(`There are ${numberOfCommits} commits`)
...
// for (let i = 0; i < githubData.payload.commits; i++) {
//     //set variable equal to index
//     const data = githubData[i].payload.commits;
//     //if variable matches certain index positioned element 'commits'
//     if (data === 'githubData.payload.commits[i]') {
//         //add one to counter
//         commitsCounter++
